...
DOM elements that are navigable through buttons (typically the arrow keys) contain the cascading class indicated by the `BUTTON_NAVIGABLE` constant in `@hydroperx/metrodesign/utils`.
